...
Dialog.create("get particle ");
	...
	Dialog.addNumber("color ratio high", 1.5);
	Dialog.addNumber("color ratio brightness", 50);
	Dialog.addNumber("color threshold Hue", 150);
	Dialog.addNumber("color threshold brightness", 90);
	Dialog.addNumber("particle size", 100);
	Dialog.addNumber("particle shape mini", 0);
	Dialog.addNumber("particle shape max", 0.7);
...
for (l = 0; l < son_file_list.length; l++){
	if (startsWith(son_file_list[l],"muscle_")){
