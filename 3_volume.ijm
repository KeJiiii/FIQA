...
//run combine for all the C1 figure or C2 figure
	...
	b=dir+son_directory+"\\"+a+"A01_G001_0002.oir";
	c=dir+son_directory+"\\"+a+"A01_G002_0002.oir";
	d=dir+son_directory+"\\"+a+"A01_G003_0001.oir";
	run("Bio-Formats", "open="+b+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	run("Bio-Formats", "open="+c+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	run("Bio-Formats", "open="+d+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	...
	//run("Bio-Formats", "open="+h+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	//run("Bio-Formats", "open="+k+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	run("Combine...", "stack1="+a+"A01_G001_0002.oir"+" stack2="+a+"A01_G002_0002.oir");
	run("Combine...", "stack1=[Combined Stacks]"+" stack2="+a+"A01_G003_0001.oir");
	//run("Combine...", "stack1=[Combined Stacks]"+" stack2="+a+"A01_G004_0001.oir");
	//run("Combine...", "stack1=[Combined Stacks]"+" stack2="+a+"A01_G005_0001.oir");
	//run("Combine...", "stack1=[Combined Stacks]"+" stack2="+a+"A01_G006_0001.oir");
	...
	run("Subtract Background...", "rolling=200 stack");
	setMinAndMax(0, 4095);
	saveAs("Tiff", dir+a+"v2-C1-Combined Stacks");
	selectWindow(a+"v2-C1-Combined Stacks.tif");
	run("Z Project...", "projection=[Average Intensity] all");
	saveAs("Tiff", dir+"AVG_"+a+"v2-C1-Combined Stacks");
	
	selectWindow("C2-Combined Stacks");
	run("Subtract Background...", "rolling=200 stack");
	setMinAndMax(0, 4095);
	saveAs("Tiff", dir+a+"v2-C2-Combined Stacks");
	selectWindow(a+"v2-C2-Combined Stacks.tif");
	run("Z Project...", "projection=[Average Intensity] all");
	saveAs("Tiff", dir+"AVG_"+a+"v2-C2-Combined Stacks");
	
	selectWindow("C3-Combined Stacks");
	run("Subtract Background...", "rolling=200 stack");
	setMinAndMax(0, 4095);
	saveAs("Tiff", dir+a+"v2-C3-Combined Stacks");
	selectWindow(a+"v2-C3-Combined Stacks.tif");
	run("Z Project...", "projection=[Average Intensity] all");
	saveAs("Tiff", dir+"AVG_"+a+"v2-C3-Combined Stacks");
	
	close("*");


	b=dir+son_directory+"\\"+a+"A01_G001_0003.oir";
	c=dir+son_directory+"\\"+a+"A01_G002_0003.oir";
	d=dir+son_directory+"\\"+a+"A01_G003_0001.oir";
	run("Bio-Formats", "open="+b+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	run("Bio-Formats", "open="+c+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	run("Bio-Formats", "open="+d+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	...
	//run("Bio-Formats", "open="+h+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	//run("Bio-Formats", "open="+k+" autoscale color_mode=Default rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT");
	run("Combine...", "stack1="+a+"A01_G001_0003.oir"+" stack2="+a+"A01_G002_0003.oir");
	run("Combine...", "stack1=[Combined Stacks]"+" stack2="+a+"A01_G003_0001.oir");
	//run("Combine...", "stack1=[Combined Stacks]"+" stack2="+a+"A01_G004_0001.oir");
	//run("Combine...", "stack1=[Combined Stacks]"+" stack2="+a+"A01_G005_0001.oir");
	//run("Combine...", "stack1=[Combined Stacks]"+" stack2="+a+"A01_G006_0001.oir");
	...
	run("Subtract Background...", "rolling=200 stack");
	setMinAndMax(0, 4095);
	saveAs("Tiff", dir+a+"v3-C1-Combined Stacks");
	selectWindow(a+"v3-C1-Combined Stacks.tif");
	run("Z Project...", "projection=[Average Intensity] all");
	saveAs("Tiff", dir+"AVG_"+a+"v3-C1-Combined Stacks");
	
	selectWindow("C2-Combined Stacks");
	run("Subtract Background...", "rolling=200 stack");
	setMinAndMax(0, 4095);
	saveAs("Tiff", dir+a+"v3-C2-Combined Stacks");
	selectWindow(a+"v3-C2-Combined Stacks.tif");
	run("Z Project...", "projection=[Average Intensity] all");
	saveAs("Tiff", dir+"AVG_"+a+"v3-C2-Combined Stacks");
	
	selectWindow("C3-Combined Stacks");
	run("Subtract Background...", "rolling=200 stack");
	setMinAndMax(0, 4095);
	saveAs("Tiff", dir+a+"v3-C3-Combined Stacks");
	selectWindow(a+"v3-C3-Combined Stacks.tif");
	run("Z Project...", "projection=[Average Intensity] all");
	saveAs("Tiff", dir+"AVG_"+a+"v3-C3-Combined Stacks");
